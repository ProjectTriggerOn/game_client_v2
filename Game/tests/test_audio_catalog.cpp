...
int main()
{
    ...
    // feedback to trigger it, and as `weapon_take_out` was, for want of a
    // correct source asset (S_WEP_Unholster.wav turned out to be wall-lower
    // foley, not a draw) — is a deliberate edit here and not a silently
    // narrower sweep below.
