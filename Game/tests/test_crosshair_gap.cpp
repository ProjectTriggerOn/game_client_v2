...
//
// The gap is driven by Game_Draw from:
//   - PlayerFps::GetSpreadRadians()      — the real aim cone
//   - PlayerFps::GetVisualPunchPitch()   — the DECAYING punch only
...
int main()
{
    ...
    //-------------------------------------------------------------------------
    {
        ...
        const float gap = Crosshair::GapTargetPixels(fresh, PlayerTeam::RED, false);
    ...
    //-------------------------------------------------------------------------
    {
        ...
        const float fresh  = Crosshair::GapTargetPixels(spawn, PlayerTeam::RED, false);
        const float rested = Crosshair::GapTargetPixels(rs, PlayerTeam::RED, false);
    ...
    //-------------------------------------------------------------------------
    {
        ...
        const RecoilState spawn;
        const float firing  = Crosshair::GapTargetPixels(rs, PlayerTeam::RED, false);
        const float settled = Crosshair::GapTargetPixels(spawn, PlayerTeam::RED, false);
    ...
    {
        const RecoilState spawn;
        CHECK(Crosshair::GapTargetPixels(spawn, PlayerTeam::RED, true)
                < Crosshair::GapTargetPixels(spawn, PlayerTeam::RED, false),
