...
// Shared lighting math (ApplyLighting, PointLightContribution). Included
// AFTER the cbuffer declarations because fxc compiles single-pass and the
// functions reference the cbuffer globals by name.
...
float4 main(PS_IN pi) : SV_TARGET
{
    ...
    // lighting_common.hlsli: directional + ambient + specular (Phong)
